...
function reportHtml(analysis: AnalysisResponse): string {
  ...
  return `<!doctype html><html lang="id"><head><meta charset="utf-8"><title>Laporan LOKABIS</title><style>
    @page { size: A4; margin: 18mm; } * { box-sizing: border-box; } body { color:#14213d; font-family:Arial,sans-serif; font-size:10.5pt; line-height:1.45; } h1 { color:#0f766e; margin:0; font-size:25pt; } h2 { color:#0f766e; font-size:14pt; margin:24px 0 8px; border-bottom:1px solid #cbd5e1; padding-bottom:4px; } p { margin:6px 0; } .meta { color:#64748b; } .hero { margin:18px 0; padding:16px; background:#ecfeff; border-left:5px solid #0f766e; } .score { font-size:34pt; font-weight:700; color:#0f172a; } .grid { display:grid; grid-template-columns:1fr 1fr; gap:16px; } table { width:100%; border-collapse:collapse; margin-top:8px; } th,td { padding:7px; text-align:left; border-bottom:1px solid #e2e8f0; } th { color:#475569; font-size:9pt; text-transform:uppercase; } .footer { margin-top:28px; padding-top:10px; border-top:1px solid #cbd5e1; color:#64748b; font-size:8.5pt; } @media print { .no-print { display:none; } }
